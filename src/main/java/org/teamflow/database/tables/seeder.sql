...
-- Insert projects
INSERT IGNORE INTO Project (name, description) VALUES
...
INSERT IGNORE INTO User_Project (user_id, project_id, role_id) VALUES
...
-- Insert epics
INSERT IGNORE INTO Epic (project_id, title) VALUES
                                         (1, 'User Registration Flow'),
                                         (1, 'Task Management Module');

-- Insert user stories
INSERT IGNORE INTO UserStory (epic_id, description) VALUES
...
-- Insert tasks
INSERT IGNORE INTO Task (title, status, story_id) VALUES
...
-- Insert a sprint
INSERT IGNORE INTO Sprint (project_id, start_date, end_date) VALUES
    (1, '2024-04-01', '2024-04-14');

-- Assign tasks to the sprint
INSERT IGNORE INTO Sprint_Task (sprint_id, task_id) VALUES
                                                 (1, 1),
                                                 (1, 2),
                                                 (1, 3);

-- Create chatrooms
INSERT IGNORE INTO Chatroom (name) VALUES
...
INSERT IGNORE INTO Message (chatroom_id, user_id, content, timestamp) VALUES
                                                                   (1, 1, 'Working on the registration page today', NOW()),
                                                                   (2, 3, 'Task module is now complete!', NOW());

-- Connect chatrooms to entities
INSERT IGNORE INTO Epic_Chatroom (chatroom_id, epic_id) VALUES
    (1, 1);

INSERT IGNORE INTO Task_Chatroom (chatroom_id, task_id) VALUES
    (2, 3);

-- Connect chatrooms to entities
INSERT IGNORE INTO Story_Chatroom (chatroom_id, story_id) VALUES
    (3, 1);

INSERT IGNORE INTO Sprint_Chatroom (chatroom_id, sprint_id) VALUES
    (4, 1);
